  ...
  return (
    <main className="min-h-screen flex flex-col bg-[#fafafa] text-zinc-950 font-sans">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-6 py-32">
        ...
        <h1 className="text-7xl font-serif font-black tracking-tight text-zinc-950 mb-4">403</h1>
        <h2 className="text-2xl font-bold text-zinc-800 mb-6">Access Forbidden</h2>
        <p className="text-zinc-500 max-w-md mx-auto mb-10 leading-relaxed">
          You do not have permission to view this resource. This area is restricted to authorized personnel.
        </p>
        <Link 
          href="/"
